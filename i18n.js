...
const I18n = {
  ...
  strings: {
    ...
    'welcome.feature2.desc': {
      ar: 'التوازن، التحمل وقدرة التباطؤ',
      en: 'Balance, endurance & deceleration capacity'
    },
    ...
    'confidence.q1.title': {
      ar: 'ما مدى ثقتك في كاحلك أثناء القطع، القفز، أو الهبوط؟',
    ...
    'phase2.transition.desc': {
      ar: 'الآن سنختبر القدرة الوظيفية الحقيقية لكاحلك. ستقوم بإجراء ٣ اختبارات بدنية سريعة لتقييم التوازن والتحمل وقدرة التباطؤ.',
      en: 'Now let\'s test your ankle\'s real functional capacity. You\'ll perform 3 quick physical tests to assess balance, endurance, and deceleration ability.'
    },
    ...
    // ==========================================
    'decel.label': {
      ar: 'المرحلة ٢ — قدرة التباطؤ',
      en: 'Phase 2 — Deceleration Capacity'
    },
    'decel.title': {
      ar: 'اختبار الهبوط والتباطؤ',
      en: 'Deceleration Drop Test'
    },
    'decel.purpose': {
      ar: 'اختبار التحميل اللامركزي وامتصاص قوة الكبح.',
      en: 'Testing eccentric loading and braking force absorption.'
    },
    'decel.instructions.title': {
      ar: 'التعليمات',
      en: 'Instructions'
    },
    'decel.step1': {
      ar: 'ابحث عن درجة أو سطح مرتفع (١٠–٢٠ سم)',
      en: 'Find a step or raised surface (4–8 in / 10–20 cm)'
    },
    'decel.step2': {
      ar: 'قف على الحافة بقدمك المصابة',
      en: 'Stand on the edge with your affected foot'
    },
    'decel.step3': {
      ar: 'انزل للأمام، واهبط على قدمك المصابة فقط',
      en: 'Step off forward, landing on your affected foot only'
    },
    'decel.step4': {
      ar: 'حاول تثبيت الهبوط — امتص الصدمة وثبّت لمدة ٣ ثوانٍ',
      en: 'Try to stick the landing — absorb and hold for 3 seconds'
    },
    'decel.step5': {
    ...
    'decel.opt1.desc': {
      ar: 'بدون اهتزاز، شعرت بثبات كامل',
      en: 'No wobble, felt completely stable'
    },
    'decel.opt2.label': {
      ar: 'اهتزاز خفيف',
      en: 'Slight wobble'
    ...
    'decel.opt2.desc': {
      ar: 'هبطت لكن اهتززت، تعافيت بسرعة',
      en: 'Landed but wobbled, recovered quickly'
    },
    'decel.opt3.label': {
      ar: 'هبوط غير مستقر',
      en: 'Unstable landing'
    ...
    'decel.opt3.desc': {
      ar: 'اهتزاز ملحوظ، الكاحل شعر بعدم الثبات',
      en: 'Significant wobble, ankle felt unstable'
    },
    'decel.opt4.label': {
      ar: 'لم أستطع الإكمال',
    ...
    'decel.opt4.desc': {
      ar: 'لم أستطع تثبيت الهبوط أو شعرت بعدم الأمان',
      en: 'Couldn\'t stick it or felt unsafe to try'
    },
    'decel.skip': {
      ar: 'لا يوجد درج متاح — تخطي هذا الاختبار',
      en: 'No step available — skip this test'
    },
    ...
    'results.email.desc': {
      ar: 'احصل على تقرير تقييمك المفصل عبر بريدك الإلكتروني.',
      en: 'Get your detailed assessment report sent to your inbox.'
    },
    'results.email.placeholder': {
      ar: 'بريدك الإلكتروني',
    ...
    'cat.deceleration': { ar: 'التباطؤ', en: 'Deceleration' },
